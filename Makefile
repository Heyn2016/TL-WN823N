...
#Heyn
CONFIG_PLATFORM_IMX6Q_TORADEX = y
###############################################################
...
#Heyn
ifeq ($(CONFIG_PLATFORM_IMX6Q_TORADEX), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
ARCH := arm
CROSS_COMPILE := /home/he/share/02_SourceLibrary/ToolChain/gcc-linaro/bin/arm-linux-gnueabihf-
KVER  := 3.14.52
KSRC := /home/he/share/02_SourceLibrary/linux-toradex/
MODULE_NAME := wlan
endif
